import{j as n,a as r}from"../chunk-f4b53398.js";import{I as s}from"../chunk-10b38355.js";const d={title:"Personas & Storyboarding"};function t(i){const e=Object.assign({main:"main",p:"p",a:"a",h1:"h1",h2:"h2",strong:"strong",em:"em",ul:"ul",li:"li",ol:"ol",code:"code",h3:"h3",hr:"hr"},i.components);return r(e.main,{children:[`
`,`
...
`,n(s,{images:[{src:"/personas-storyboarding/gradescope-ui.png",alt:"A screenshot of Gradescope's grading dashboard"}],targetWidth:"75%",children:r(e.p,{children:[n(e.strong,{children:"Figure 1:"})," A screenshot of Gradescope's grading dashboard."]})}),`
...
`,r(s,{images:[{src:"/personas-storyboarding/gradescope-ui-sketch.png",alt:"An annotated sketch of Gradescope's grading dashboard and question grading interface"}],targetWidth:"125%",children:[r(e.p,{children:[n(e.strong,{children:"Figure 2:"})," Annotated sketches of Gradescope's main grading interfaces."]}),n(e.p,{children:"Key interactive elements have been exaggerated and emphasized (in orange)."})]}),`
...
`,n(s,{images:[{src:"/personas-storyboarding/storyboard.png",alt:"A storyboard depicting Beginner Bob's pain points while using Gradescope."}],targetWidth:"150%",children:r(e.p,{children:[n(e.strong,{children:"Figure 5:"})," A storyboard depicting Beginner Bob's pain points while using Gradescope."]})}),`
...
`,n(e.hr,{}),`
`,n(e.p,{children:n(e.a,{href:"#page",children:"Back to top"})})]})}function h(i={}){const{wrapper:e}=i.components||{};return e?n(e,Object.assign({},i,{children:n(t,i)})):t(i)}export{h as default,d as documentProps};
