...
`,i(e.p,{children:"Here's the original site in all its HTML-table-element, text-made-of-images glory:"}),`
`,i(r,{images:[{src:"/responsive-redesign/website-ui-desktop.png",alt:"A desktop screenshot of the Tri-State Camera website. The page appears flushed-left."},{src:"/responsive-redesign/website-ui-mobile.jpeg",alt:"A mobile screenshot of the Tri-State Camera website."}],targetWidth:"125%",style:{"--border":"1px solid var(--edge-color)",gridTemplateColumns:`minmax(0, ${2990/1870}fr) minmax(0, ${1125/2221}fr)`},children:n(e.p,{children:[i(e.strong,{children:"Figure 1:"})," Screenshots of the Tri-State Camera website, on desktop and mobile."]})}),`
...
`,i(r,{images:[{src:"/responsive-redesign/final-website.png",alt:"My newly-responsive, redesigned website."}],targetWidth:"125%",style:{"--border":"1px solid var(--edge-color)"},children:n(e.p,{children:[i(e.strong,{children:"Figure 13:"})," My newly-responsive, redesigned website."]})}),`
