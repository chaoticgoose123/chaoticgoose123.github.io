...
`,i(s,{images:[{src:"/personas-storyboarding/gradescope-ui.png",alt:"An annotated sketch of Gradescope's grading dashboard and question grading interface"}],children:[i(e.p,{children:[n(e.strong,{children:"Figure 1:"})," Annotated sketches of Gradescope's main grading interfaces."]}),n(e.p,{children:"Key interactive elements have been exaggerated and emphasized (in orange)."})]}),`
`,i(e.p,{children:["Pictured in the images above are the main ",n(e.strong,{children:"interfaces"})," which a TA might interact with during grading. In particular, the second image shows a screen which allows TAs to score students' submissions on a ",n(e.em,{children:"per-question"})," basis, checking rubric items to add or subtract points from the submission."]}),`
`,i(e.p,{children:["Not pictured are the numerous ",n(e.strong,{children:"keyboard shortcuts"})," which can be used to perform the same tasks as most of these UI elements."]}),`
`,n(e.h2,{id:"observations",children:n(e.a,{href:"#observations",children:"Observations"})}),`
...
`,i(e.ul,{children:[`
`,i(e.li,{children:["There was a 50-50 split between TAs who graded ",n(e.strong,{children:"question-by-question"}),", and TAs who graded ",n(e.strong,{children:"submission-by-submission"}),". This split was along course lines."]}),`
`,i(e.li,{children:["Most users clicked on ",n(e.strong,{children:"visible UI elements"})," to navigate, instead of using ",n(e.strong,{children:"keyboard shortcuts"}),". However, almost all users used keyboard shortcuts to check rubric items."]}),`
`,i(e.li,{children:["Users rarely had to ",n(e.strong,{children:"navigate to a previous submission"}),"; but when they did, especially when several TAs were grading in parallel, they took a long time to do so."]}),`
`]}),`
...
`,i(e.ol,{children:[`
`,i(e.li,{children:[i(e.strong,{children:["How ",n(e.em,{children:"experienced"})," are you in using Gradescope as a TA?"]}),`
`,i(e.ul,{children:[`
...
`]}),`
`]}),`
`,i(e.li,{children:[i(e.strong,{children:["What was your ",n(e.em,{children:"goal"})," in using Gradescope?"]}),`
`,i(e.ul,{children:[`
...
`]}),`
`]}),`
`,i(e.li,{children:[i(e.strong,{children:["Which ",n(e.em,{children:"specific part(s)"})," of its interface did you use to attempt to achieve that goal?"]}),`
`,i(e.ul,{children:[`
...
`]}),`
`]}),`
`,i(e.li,{children:[i(e.strong,{children:["Could you describe one or more ways in which Gradescope's UI ",n(e.em,{children:"helped"})," or ",n(e.em,{children:"hindered"})," your work?"]}),`
`,i(e.ul,{children:[`
...
`]}),`
`]}),`
`,i(e.li,{children:[i(e.strong,{children:["If you could ",n(e.em,{children:"change anything about Gradescope"})," to improve your user ",n(e.em,{children:"experience"}),", what would it be?"]}),`
`,i(e.ul,{children:[`
...
`]}),`
`]}),`
`,n(e.h2,{id:"personas",children:n(e.a,{href:"#personas",children:"Personas"})}),`
`,i(e.p,{children:["Based on my findings, I constructed two ",n(e.strong,{children:"personas"})," to broadly represent the users I observed."]}),`
`,n(e.h3,{id:"adept-alice",children:n(e.a,{href:"#adept-alice",children:"Adept Alice"})}),`
...
`,n(s,{images:[{src:"/personas-storyboarding/persona-b.png",alt:"An empathy map depicting what Beginner Bob thinks, feels, says, and does."}],targetWidth:"75%",children:i(e.p,{children:[n(e.strong,{children:"Figure 3:"})," An empathy map depicting what ",n(e.strong,{children:"Beginner Bob"}),", an archetypal user of Gradescope, thinks, feels, says, and does."]})}),`
`,n(e.h2,{id:"storyboard",children:n(e.a,{href:"#storyboard",children:"Storyboard"})}),`
...
`,n(s,{images:[{src:"/personas-storyboarding/storyboard.png",alt:"A storyboard depicting Beginner Bob's pain points while using Gradescope."}],children:i(e.p,{children:[n(e.strong,{children:"Figure 4:"})," A storyboard depicting Beginner Bob's pain points while using Gradescope."]})}),`
`,i(e.p,{children:["Grading is hard. Perhaps we could ",n(e.em,{children:"crowdsource"})," it on a ",n(e.em,{children:"non-Gradescope platform"}),", instead!"]}),`
...
`,n(e.hr,{}),`
`,n(e.p,{children:n(e.a,{href:"#page",children:"Back to top"})})]})}function h(r={}){const{wrapper:e}=r.components||{};return e?n(e,Object.assign({},r,{children:n(t,r)})):t(r)}export{h as default,d as documentProps};
