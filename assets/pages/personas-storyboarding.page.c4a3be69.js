import{a as s,j as n}from"../chunk-f4b53398.js";function i({images:r,targetWidth:e="100%",children:t}){return s("figure",{className:"image-wrapper",children:[n("div",{className:"image-grid",style:{"--target-width":e},children:r.map((o,d)=>n("a",{href:o.src,target:"_blank",rel:"noopener noreferrer",children:n("img",{...o})},d))}),t!=null&&n("figcaption",{children:t})]})}const c={title:"Personas & Storyboarding"};function a(r){const e=Object.assign({main:"main",h1:"h1",h2:"h2",blockquote:"blockquote",p:"p",em:"em",strong:"strong",a:"a",ul:"ul",li:"li",ol:"ol",code:"code",h3:"h3",hr:"hr"},r.components);return s(e.main,{children:[`
`,`
...
`]}),`
`,s(e.p,{children:["To explore the use of ",n(e.strong,{children:"personas"})," and ",n(e.strong,{children:"storyboarding"})," in UX research, I chose to investigate how CS TAs use Gradescope for grading."]}),`
`,n(e.h2,{children:"The Interface"}),`
`,s(e.p,{children:[n(e.a,{href:"https://en.wikipedia.org/wiki/Gradescope",target:"_blank",rel:"noopener noreferrer",children:"Gradescope"})," is a website used to administer coursework. It allows instructors to set up assignments\u2014comprising questions and rubrics with point values\u2014and collect student submissions. TAs can then view and grade these submissions."]}),`
`,s(i,{images:[{src:"/personas-storyboarding/gradescope-ui-grading.png",alt:"Gradescope's grading dashboard interface"},{src:"/personas-storyboarding/gradescope-ui-question.png",alt:"Gradescope's question grading interface"}],children:[n(e.p,{children:"Sketches of Gradescope's main grading interfaces."}),n(e.p,{children:"Key interactive elements have been exaggerated and emphasized (in orange)."})]}),`
`,s(e.p,{children:["Pictured in the images above are the main ",n(e.strong,{children:"interfaces"})," which a TA might interact with during grading. In particular, the second image shows a screen which allows TAs to score students' submissions on a ",n(e.em,{children:"per-question"})," basis, checking rubric items to add or subtract points from the submission."]}),`
`,s(e.p,{children:["Not pictured are the numerous ",n(e.strong,{children:"keyboard shortcuts"})," which can be used to perform the same tasks as most of these UI elements."]}),`
...
`,s(e.ul,{children:[`
`,s(e.li,{children:["There was a 50-50 split between TAs who graded ",n(e.strong,{children:"question-by-question"}),", and TAs who graded ",n(e.strong,{children:"submission-by-submission"}),". This split was along course lines."]}),`
`,s(e.li,{children:["Most users clicked on ",n(e.strong,{children:"visible UI elements"})," to navigate, instead of using ",n(e.strong,{children:"keyboard shortcuts"}),". However, almost all users used keyboard shortcuts to check rubric items."]}),`
`,s(e.li,{children:["Users rarely had to ",n(e.strong,{children:"navigate to a previous submission"}),"; but when they did, especially when several TAs were grading in parallel, they took a long time to do so."]}),`
`]}),`
...
`,s(e.ol,{children:[`
`,s(e.li,{children:[s(e.strong,{children:["How ",n(e.em,{children:"experienced"})," are you in using Gradescope as a TA?"]}),`
`,s(e.ul,{children:[`
...
`]}),`
`]}),`
`,s(e.li,{children:[s(e.strong,{children:["What was your ",n(e.em,{children:"goal"})," in using Gradescope?"]}),`
`,s(e.ul,{children:[`
...
`]}),`
`]}),`
`,s(e.li,{children:[s(e.strong,{children:["Which ",n(e.em,{children:"specific part(s)"})," of its interface did you use to attempt to achieve that goal?"]}),`
`,s(e.ul,{children:[`
...
`]}),`
`]}),`
`,s(e.li,{children:[s(e.strong,{children:["Could you describe one or more ways in which Gradescope's UI ",n(e.em,{children:"helped"})," or ",n(e.em,{children:"hindered"})," your work?"]}),`
`,s(e.ul,{children:[`
...
`]}),`
`]}),`
`,s(e.li,{children:[s(e.strong,{children:["If you could ",n(e.em,{children:"change anything about Gradescope"})," to improve your user ",n(e.em,{children:"experience"}),", what would it be?"]}),`
`,s(e.ul,{children:[`
...
`,s(e.p,{children:["Based on my findings, I constructed two ",n(e.strong,{children:"personas"})," to broadly represent the users I observed."]}),`
...
`,n(i,{images:[{src:"/personas-storyboarding/storyboard.png",alt:"A storyboard depicting Beginner Bob's pain points while using Gradescope."}]}),`
`,s(e.p,{children:["Grading is ",n(e.em,{children:"hard"}),". Perhaps we could crowdsource it on a non-Gradescope platform, instead!"]}),`
...
`,n(e.hr,{}),`
`,n(e.p,{children:n(e.a,{href:"#page",children:"Back to top"})})]})}function l(r={}){const{wrapper:e}=r.components||{};return e?n(e,Object.assign({},r,{children:n(a,r)})):a(r)}export{l as default,c as documentProps};
